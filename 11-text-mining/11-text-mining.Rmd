...
NOTE: Using $n$-gram with $n$>2 is typically impractical due to the fact that the column dimension of $\mathbf{X}$ increases exponentially with the order $n$.
