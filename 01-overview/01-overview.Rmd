...
Our class website: [https://huji-ml4econ.github.io/course-spring2019](https://huji-ml4econ.github.io/course-spring2019/index.html)
...
We will use a [GitHub discussion repository](https://github.com/huji-ml4econ/discussion-spring2019). To use it, you'll need to create a GitHub account and ask for an invitations from Itamar.  
...
- Computational aspects (e.g., convex optimization)

- Data wrangling (a.k.a. "feature engeneering")

- Distributed clusters (e.g., Spark) 
...
> All materials and lecture notes will be available on the [class website](https://huji-ml4econ.github.io/course-spring2019/lectures.html).
...
* Why R? See presentation notes and the [FAQ section](https://huji-ml4econ.github.io/course-spring2019/faq.html) of our class website.  
...
- [DataCamp Classroom](https://www.datacamp.com/enterprise/machine-learning-for-economists): you will be assigned with specific courses that will teach you essential R skills.
...
<i class="fas fa-check-square"></i> Ask Itamar to invite you to the [huji-ml4econ](https://github.com/huji-ml4econ) GitHub organization
...
<i class="fas fa-check-square"></i> Create an account on [Kaggle](https://huji-ml4econ.github.io/course-spring2019/www.kaggle.com) and ask Itamar to invite you the course's [prediction competition](https://www.kaggle.com/t/97eb0edcbe7c406882c7c067076bedd3).



.footnote[
[*] Please consult the [Guides](https://huji-ml4econ.github.io/course-spring2019/RnRStudio.html) section in our course's website.
]
...
[<i class="fa fa-github"></i> Source code](https://github.com/huji-ml4econ/01-overview)  
