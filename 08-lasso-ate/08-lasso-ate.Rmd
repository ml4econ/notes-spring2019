...
author: "Itamar Caspi"
date: "April 29, 2019 (updated: `r Sys.Date()`)"
output:
...
$$\begin{aligned} \mathbb{E}\left[Y_{i} | D_{i}=1\right]-\mathbb{E}\left[Y_{i} | D_{i}=0\right] &=\mathbb{E}\left[Y_{1 i} | D_{i}=1\right]-\mathbb{E}\left[Y_{0} | D_{i}=0\right] \\ &=\mathbb{E}\left[Y_{1 i} | D_{i}=1\right]-\mathbb{E}\left[Y_{0 i} | D_{i}=1\right] \\
...
| Elastic Net | $\alpha\lVert\boldsymbol{\beta}\rVert_0 + (1-\alpha)\lVert\boldsymbol{\beta}\rVert_2^2$ |
...
$$\text{Loss}_{\text{ pred }}\left(\widehat{\boldsymbol{\beta}} ; \boldsymbol{\beta}^{0}\right)=\frac{1}{N}\left\|\mathbf{X}^{} \widehat{\boldsymbol{\beta}}-\mathbf{X}^{} \boldsymbol{\beta}^{0}\right\|_{2}^{2}$$

II. Parameter consistency

$$\text{Loss}_{\text{param}}\left(\widehat{\boldsymbol{\beta}} ; \boldsymbol{\beta}^{*}\right)=\left\|\widehat{\boldsymbol{\beta}}-\boldsymbol{\beta}^{0}\right\|_{2}^{2}$$
